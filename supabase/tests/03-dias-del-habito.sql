...
\echo '--- 5. saltarse un día que SÍ tocaba reinicia el reto ---'
\echo '    (el miércoles 12 sin haber marcado el lunes 10: 0)'
do $$
declare r integer;
begin
  select current_streak into r
  ...
  raise notice 'OK: faltar un día de los que tocan reinicia; va en 0';
end $$;
...
begin
  ...
  raise notice 'OK: 3 el jueves (aún sin marcar) y 0 el viernes (el jueves quedó sin marcar)';
end $$;
