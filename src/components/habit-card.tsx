 ...
 *
 * Trae `motion` y `canvas-confetti`, y montada siempre —aunque sea con `day`
 * en null— las dos librerías viajaban en el bundle inicial de Hoy, en cada
 * tarjeta, los 364 días del año en que no se llega a ningún hito. Con
 * `dynamic` se bajan la primera vez que alguien llega a uno.
 */
...
export function HabitCard({
  ...
  return (
    <>
      ...
      <div
        className="entrar flex flex-col gap-1.5"
      ...
      >
        ...
        {error && (
          <p role="alert" className="px-2 text-[13px] leading-[1.35] text-rojo">
            {error}
          </p>
        )}
      </div>
