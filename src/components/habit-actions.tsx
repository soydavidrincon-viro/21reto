    ...
    <div className="mx-4 mt-1 flex flex-col gap-1">
      ...
      {confirming ? (
        <div className="flex flex-col gap-2 rounded-[14px] bg-card p-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="h-11 flex-1 rounded-xl bg-yellow text-[15px] font-semibold text-[#4A3A00] disabled:opacity-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue"
            >
              Sí, registrar
            </button>
            <button
        ...
        <button
          ...
          className="flex h-11 items-center justify-center text-[15px] font-medium tracking-[-0.01em] text-label-2 disabled:opacity-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue"
        >
